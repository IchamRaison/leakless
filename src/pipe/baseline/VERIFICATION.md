...
Claude a lu les modules et exécuté la version intermédiaire : **86 tests réussis en 10,66 secondes**, bus #309. Son objection sur l'objectif de sélection a conduit à remplacer l'exactitude par le macro-F1 parmi les réponses retenues, sous couverture minimale. Cet objectif reste à valider par Nevil ; le rappel global conserve toutes les fuites au dénominateur. Relecture finale reçue dans #312 : **88 tests réussis en 10,75 secondes**, aucun autre défaut relevé. Le run synthétique final du commit propre `9b897f9`, dans `/private/tmp/pipe-vincent-analyses-final-20260912/run`, a aussi été rechargé dans douze processus neufs : douze prédictions aux classes, scores et abstentions exactement identiques.
