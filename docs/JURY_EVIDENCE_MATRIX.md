...
| CLAIM | EVIDENCE | STATUS | LIMITATION | DEMO ARTIFACT |
|---|---|---|---|---|
| **La modélisation temporelle apporte quelque chose** | comparaison appariée TSLM − C1 (et non TSLM − C0) | **PAS ENCORE DÉMONTRÉ** | le barreau est C1 = 0,902 / 0,927, pas C0 | commande §Intégration ci-dessous |
...
2. On a mesuré qu'un volumètre atteint 0,878 d'AUC. Puis on a normalisé l'amplitude
   ...
   d'enveloppe seule fait mieux (0,902).
...
4. La question temporelle est posée proprement, avec le bon barreau (C1) et des jeux
   de stress dont les invariants sont mesurés. **Elle attend le TSLM.**
