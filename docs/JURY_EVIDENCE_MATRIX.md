...
| **C2b est réellement temporel, pas du spectre déguisé** | même modèle, sans réentraînement : corrélation des probabilités avec T0 de **0,748** sous permutation de blocs et **0,724** sous phase randomisée ; dégradation d'AUC sous T3 de **−0,121**, IC95 [+0,068, +0,283] en apparié | **démontré** | T1 (inversion) ne le bouge presque pas — prédit avant mesure, c'est un stress faible pour ces descripteurs | `docs/C2B_HYPOTHESIS.md` §Stress |
