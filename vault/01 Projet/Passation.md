...
**Priorité autorisée : [[Rush Qwen 27B - exécution]].** Une heure09:17–10:17Paris, Qwen3.8-27B BF16+LoRA, une recette sur3folds internes train ; deux H100 indépendantes, aucun test officiel/externe. Téléchargements identiques,223tests runtime, backward fini dans les3composants, base inchangée et30% de margeVRAM ; reload neuf sur les2nœuds et parité inter-nœuds à écart0. Budget figé avant comparaison :**microbatch4,1époque** par fold, arrêt10:02. Gate `b70a408` publié avant fits. **Fits lancés :** H100-1 fold0 (handle76771), H100-2 fold1 puisfold2 (handle30641), code immuable `dae7e22`, dossiers `rush-qwen27b-001/fold-N`. Fold1 a effectué47pas et vérifie/sauvegarde ses poids ; fold0 approche63pas. Aucun résultat réservé27B encore. Ne pas relancer un fit vivant. Ce goal de rush ne signifie pas que le plan produit en dix étapes ci-dessous est terminé.
