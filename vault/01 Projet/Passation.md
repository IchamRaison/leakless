...
**Demande actuelle : discuter, sans implémenter.** Icham propose C1 + LSTM + LLM de notification, sans interprétation ni décision confiées à Qwen. Piste consignée, pas changement d'architecture adopté : [[Journal Icham#13 septembre — proposition acoustique, suivi temporel et notification]]. Prochaine action : discuter de la nécessité du LSTM, des données continues nécessaires et de la compatibilité avec le brief TSLM ; aucun entraînement ou envoi WhatsApp autorisé par cette proposition.
