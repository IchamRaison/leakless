...
**Objectif de diagnostic désormais autorisé par Icham : [[Diagnostic causal - exécution]].** Six fits précédents récupérés/vérifiés, artefacts `b65042a`. Moyennes AUC clip/groupe : A=0,580892/0,671474 ; C=0,533075/0,562500 ; C1=0,891382/0,948718 ; développement uniquement, aucune adoption pour refit. D0 en cours d'implémentation : A0/C0, états initial/terminal, 500 vus/98 réservés séparés et interventions sur32 ; budget1516 observations sans apprentissage. Prochaine action : tests/runtime et préinscription machine avant lancement. Ancienne suite V2 et confirmation externe restent suspendues ; aucune nouvelle recette.
