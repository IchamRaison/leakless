...
**V2 — 13 septembre : 3/6 fits complets et vérifiés.** [[V2 ML - exécution]] : A0/A1/C0 terminés, artefacts `83bcbe0` / `fa1b9b4`, Qwen inchangé et acoustique réellement entraînée. AUC clip/groupe A0 0,710/0,760, A1 0,563/0,736, C0 0,499/0,500 ; résultats partiels nettement derrière C1 sur les mêmes folds, aucun choix final. **A2 (`88307`, PID70853) et C/fold1 (`77795`, PID70917) actifs sur H100 ; C/fold2 suivra dans la même file**. Ne pas relancer les trois fits terminés. C1 comparateur a terminé ses12 fits. Campagne `c13fd47`, préinscription SHA `5c5e0b4b…` inchangée, deux gates/reloads A/C PASS deltas nuls. Générateur de rapport V2 `0c99a3a`, 162 tests runtime passent, sans nouveau moteur. Prochaine action : finir les six fits, classer/rendre les résultats de développement puis examiner le progrès face à C1 avant tout refit. Aucun seuil final ni score externe. **Checkout actif `/home/animus/ehl-hackathon-zurich-v2-recovery`** ; ancien Git endommagé conservé, ne pas y commiter. [[Plan V2 - fiabilité et parité des scores#7. Objectif final — démontrer la valeur du TSLM]] reste le cap final : événements, investigation et comparaison gabarit/Qwen/TSLM, aucune capacité présumée acquise par cette campagne sur extraits.
