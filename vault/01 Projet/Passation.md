...
**V2 — 13 septembre : reprise demandée ; cap final TSLM ajouté au plan.** [[Plan V2 - fiabilité et parité des scores#7. Objectif final — démontrer la valeur du TSLM]] : comprendre/investiguer les événements, comparer gabarit, Qwen sur mesures et TSLM sur séries ; aucune capacité présumée acquise. [[V2 ML - exécution]] : parité complète et reload `0b1399e` PASS (209 clips, delta zéro), compatibilité V1 terminée. Diagnostic 598 train : sonde TimeNet AUC groupée moyenne 0,636 contre C1 0,938, pas un score TSLM ; B omise, A/C retenues pour préinscription. Nouveaux chemins C/cache/packing/accumulation écrits mais pas encore entièrement vérifiés : **nouveaux gates A/C obligatoires avant tout entraînement TSLM V2**. Manifeste externe figé SHA `84007801…`, aucun score externe. Prochaine action : tests runtime, nouveau cache806, gates/reloads A/C, puis campagne bornée. **Checkout actif `/home/animus/ehl-hackathon-zurich-v2-recovery`** ; ancien Git endommagé conservé, ne pas y commiter. Le benchmark final à trois approches reste distinct de cette campagne sur extraits.
