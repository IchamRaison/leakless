...
**D3 en cours : handle 20214, PID distant 100634, ne pas relancer.** Code `c08ff78`, revue indépendante et 222 tests runtime sans skip ; préinscription SHA `42920f6d…` publiée à `e5a8543` avant le fit. Dossier `/home/hicham/pipe-v0/artifacts/causal-d3-c08ff78-001`, sortie `quality-causal-d3-c08ff78/train.log`. Un seul A neuf/32 témoins, max1 000 pas ; point0 exactement reproduit, premiers pas/journalisation réels réussis, aucun verdict encore. Suivre ce processus puis, après reçu train intègre, `reload` neuf et vérification. [[Diagnostic causal - exécution#D3 — entraînement en cours, pas encore de verdict]]. Mémorisation ≠ généralisation ; recette inchangée pendant le run.
