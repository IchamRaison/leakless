...
**Priorité autorisée : [[Rush Qwen 27B - exécution]].** Une heure09:17–10:17Paris, Qwen3.8-27B BF16+LoRA, une recette sur3folds internes train ; deux H100 indépendantes, aucun test officiel/externe. Téléchargements identiques,223tests runtime, backward fini dans les3composants, base inchangée et30% de margeVRAM ; reload neuf sur les2nœuds et parité inter-nœuds à écart0. Budget figé avant comparaison :**microbatch4,1époque** par fold, arrêt10:02. Gate publié ; fits de comparaison à lancer immédiatement, aucun résultat qualité27B encore. Ce goal de rush ne signifie pas que le plan produit en dix étapes ci-dessous est terminé.
