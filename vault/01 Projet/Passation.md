...
**D3 en cours : handle 20214, PID distant 100634, ne pas relancer.** Code `c08ff78`, 222 tests runtime ; préinscription `42920f6d…` publiée `e5a8543` avant fit. Dossier `/home/hicham/pipe-v0/artifacts/causal-d3-c08ff78-001`, sortie `quality-causal-d3-c08ff78/train.log`. Point100 vérifié et publié `b7ffdc3` : NLL binaire0,574984,24/32corrects, AUC0,769531 ; critère non atteint, essai poursuivi sans changement jusqu'au prochain point programmé. Préfixe40pas/10époques relu indépendamment : compteurs, pertes, clipping et mises à jour cohérents. Aucun verdict final ni reload encore. Suivre le même processus puis, après reçu train intègre, `reload` neuf et audit. [[Diagnostic causal - exécution#D3 — entraînement en cours, pas encore de verdict]]. Ces32clips sont entraînés : aucune généralisation démontrée.
