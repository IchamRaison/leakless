...
**Goal élargi le 13 septembre : [[Diagnostic causal TSLM vs C1#Plan global en dix étapes]].** Le prompt reste un renvoi vers cette note. Diagnostic → corrections mesurées → diversification globale si nécessaire → mesure de cet apport → gel et confirmation indépendante → intégration continue et valeur du TSLM. Le diagnostic ne termine plus le goal. [[Diagnostic causal - exécution]] : D0/D1/D2 complets ; le lecteur non linéaire exploite mieux les mêmes entrées que la sonde linéaire, mais reste derrière C1. D3 testé/préinscrit et en cours sur 32 clips, handle 20214 à suivre sans relance, puis reload neuf. Deux runtimes H100 vérifiés ; poids/données en préparation sur la seconde. Étapes 6 à 10 non lancées ; aucun gain final TSLM ni cause unique du retard démontrés.
