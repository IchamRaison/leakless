...
**Goal élargi le 13 septembre : [[Diagnostic causal TSLM vs C1#Plan global en dix étapes]].** Le prompt reste un renvoi vers cette note. Diagnostic → corrections mesurées → diversification globale si nécessaire → mesure de cet apport → gel et confirmation indépendante → intégration continue et valeur du TSLM. Le diagnostic ne termine plus le goal. [[Diagnostic causal - exécution]] : D0 et D1 complets, aucun fit supplémentaire ; le FP32 de tête ne suffit pas à corriger le retard. Prochaine action : borner/préinscrire la sonde non linéaire des entrées exactes ; étapes 6 à 10 non lancées. Aucun gain final ni cause unique du retard sur C1 démontrés ; pas de reprise automatique de l'ancienne recette V2.
