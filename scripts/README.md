...
| `eval/verify_manifest.py` | **Independent** re-derivation of every figure in `docs/SPLIT_AUDIT.md`, straight from the audio and the CSVs. Imports nothing from `build_groups.py`. | ✅ implemented — 33 checks, exit 1 on any divergence |
